<?php
// filepath: c:\laragon\www\EBR\database\migrations\2024_01_01_000003_create_inicial_data_table.php
...
return new class extends Migration
{
    public function up()
    {
        Schema::create('inicial_data', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('nomina_por_rectificar')->default(0);
             ...
             // Campos específicos de inicial (37 columnas total)
            $table->integer('cero_hombres')->default(0);
            $table->integer('cero_mujeres')->default(0);
            ...
            $table->integer('mas_quinto_hombres')->default(0); // Agregar esta si no existe
            $table->integer('mas_quinto_mujeres')->default(0); // Agregar esta si no existe
    ...
    {
        Schema::dropIfExists('inicial_data');
    }
};