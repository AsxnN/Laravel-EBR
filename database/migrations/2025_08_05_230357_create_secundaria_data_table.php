<?php
// filepath: c:\laragon\www\EBR\database\migrations\2024_01_01_000005_create_secundaria_data_table.php
...
return new class extends Migration
{
    public function up()
    {
        Schema::create('secundaria_data', function (Blueprint $table) {
            $table->id();
            ...
            // Campos específicos de secundaria
    ...
    {
        Schema::dropIfExists('secundaria_data');
    }
};